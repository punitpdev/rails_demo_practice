ActiveAdmin.setup do |config|
  ...
  config.register_javascript "https://maps.googleapis.com/maps/api/js?key=AIzaSyB9FRw4tk_BPwto60QObo1_CNR_1uU2k5Y&libraries=maps,marker"
  # == Menu System
  #
